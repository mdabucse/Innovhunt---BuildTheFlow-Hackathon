...
export default ({
  ...
  <head>
      ...
      <script defer data-url="https://localhost/3000/tool/${toolSlug}" src="https://localhost/3000/banner/index.js"></script>
    ...
    <Modal variant="custom" isActive={isModalOpen} className="max-w-4xl">
      ...
      <div className="mt-2">
        <CodeBlock onCopy={copyDone}>
          {`<script defer data-url="https://localhost:3000/tool/${toolSlug}" src="https://localhost:3000/banner/index.js" />`}
        </CodeBlock>
      </div>
