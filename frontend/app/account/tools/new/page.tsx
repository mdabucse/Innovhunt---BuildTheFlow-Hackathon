...
export default () => {
  ...
  const handleEmbeddings = async (toolData: Tool) => {
    const openai = new OpenAI({
      apiKey: process.env.NEXT_PUBLIC_OPENAI_API_KEY,
      dangerouslyAllowBrowser: true
    });

    const textToEmbed = Object.values(toolData).join(' ');
  ...
  //       // const embeddings = await handleEmbeddings(data);
  ...
  return (
    <section className="container-custom-screen  bg-slate-800">
      <Alert context="Please ensure that your submission is relevant to the Some category of Social Impact" />
          ...
          >
            ...
            <div className="pt-7">
              <Button type="submit" isLoad={isLaunching} className="w-full hover:bg-orange-400 ring-offset-2 ring-orange-500 focus:ring">
                Schedule my Product for Launch
              </Button>
